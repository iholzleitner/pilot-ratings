...
Please note: The heatmaps visualise the frequency distribution of ratings for each model. Darker tiles indicate that more participants from a given lab (shown in separate panels) gave that particular rating (x-axis, e.g., attractiveness) to that model (y-axis).
