...
data_model <- model_raw |> 
  ...
  mutate(gender = tolower(gender),
         gender_rec = case_match(gender,
                                 c("female", "mulher", "feminino", "female.",  "f",  "mujer",  "femenino",  "trans woman",  "femal") ~ "female",
                                 c("homem", "masculino",  "mascãºlino",  "m") ~ "male",
                                 c("sexo feminino, gãªnero fluido", "nã£o binã¡rio", "nã£o binã¡rio",  "genderfluid (amab)",  "nonbinary") ~ "non-binary",
                                 c("hetero cis", "NA") ~ NA_character_,
                                 .default = gender),
         ethnicity = tolower(ethnicity),
         ethnicity_rec = case_match(ethnicity,
                                    c("white", "branco", "branca", "branca", "branco", "caucasian", 
                                      ...
                                      "scottish", "european", "eastern european", "croatian", "serbian",
                                      "romanian", "white - other", "meditrainian") ~ "White",
                                    ...
                                    c("mixed", "pardo", "parda", "pardo - mixed race", 
                                      "mixraces", "chinese-indian-malay mixed", "mixed white & asian", "mix white/black",
                                      "white / middle-eastern", "white / middle eastern", "middle eastern/white") ~ "Multiracial or Mixed",
