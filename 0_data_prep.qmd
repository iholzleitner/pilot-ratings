...
data_model <- model_raw |> 
  ...
  mutate(height_cm = case_when(height_units == "cm" & as.numeric(height) < 100 ~ as.numeric(height) * 2.54, # likely mislabelled inches
         ...
         weight_kg = case_when(as.numeric(weight) == 0 ~ NA_real_,
                               weight_units == "kg" & as.numeric(weight) < 30 ~ as.numeric(weight) * 2.20462,  # likely mislabelled lb
  ...
  mutate(ethnicity = tolower(ethnicity),
         ethnicity_rec = case_match(ethnicity,
                                    ...
                                    c("asian", "asia", "south asian", "east asian",
                                      ...
                                      "indo-aryan", "indo-fijian", "belgium, asian") ~ "Asian",
                                    c("native american", "native hawaiian", "samoan") ~ "Indigenous",
                                    ...
                                    c("mixed", "mixed race", "mix", "biracial",
                                      ...
                                      "black/white", "black/british", "black british",
                                      "chinese/uk", "british - indian", "british asian",
                                      "british pakistani", "british asian american",
                                      "latin european", "white / puerto rican",
                                      "white/ latino", "white hispanic",
                                      "white & asian", "eurasian",
